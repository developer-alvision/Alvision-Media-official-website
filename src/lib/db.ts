...
const defaultData: DatabaseSchema = {
  ...
  portfolio: [
    {
      id: 'p-1',
      title: 'Preetham Infra Web Tech & Campaign Strategy',
      category: 'Web Tech & Campaign Strategy',
      client_name: 'Preetham Infra Constructions Company',
      metrics: '10M Reach, 350% Lead Growth',
      description: 'Engineered high-performance web platforms and multi-channel campaign strategies for enterprise infrastructure developments.',
      image_url: '/images/case_skincare_web.png',
      case_study_content: 'Leveraged native distribution channels and Web Tech infrastructure to introduce digital property suites, scaling qualified lead inquiries and achieving 10M+ total audience reach.',
      created_at: '2026-06-15T00:00:00.000Z'
    },
    {
      id: 'p-2',
      title: 'MLL Hospital Digital Acquisition',
      category: 'Digital Marketing & Acquisition',
      client_name: 'MLL Hospital',
      metrics: '250% Patient Inquiries, 4.8M Reach',
      description: 'Designed targeted digital marketing, local search optimization, and patient acquisition booking funnels.',
      image_url: '/images/service_google_ads.png',
      case_study_content: 'Built high-intent search ads combined with automated appointment reminders, scaling patient consultation sign-ups while maintaining top local search rankings.',
      created_at: '2026-05-20T00:00:00.000Z'
    },
    {
      id: 'p-3',
      title: 'Jyosthna Maternity Healthcare Awareness',
      category: 'Content Creation & Distribution',
      client_name: 'Jyosthna Maternity Hospital',
      metrics: '3.2M Impressions, 45% Direct Bookings',
      description: 'High-retention video content creation and distribution for specialized maternity healthcare awareness.',
      image_url: '/images/service_social.png',
      case_study_content: 'Produced educational short-form Reels and video content packages that built strong community trust and scaled direct online appointment bookings by 45%.',
      created_at: '2026-06-28T00:00:00.000Z'
    },
    {
      id: 'p-4',
      title: 'Jyothi Dental Digital Visibility',
      category: 'Digital Marketing',
      client_name: 'Jyothi Dental Hospital',
      metrics: '180% Monthly Appointments',
      description: 'Local search campaign strategy and high-intent Google Ads performance setup for dental health services.',
      image_url: '/images/case_cart_recovery.png',
      case_study_content: 'Implemented geo-targeted search campaigns and streamlined WhatsApp booking flows, significantly reducing missed appointments and increasing patient volume.',
